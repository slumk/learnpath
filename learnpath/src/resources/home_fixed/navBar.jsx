  ...
  return (
    <div className='bg-sky-100 grid grid-cols-2'>
            <div className=" m-2 px-1 py-1.5">
                <h1 className="px-2 text-7xl font-semibold" id="main-heading">learnpath</h1>
      ...
      <div className='flex gap-5 justify-end mx-3'>
                    <form className='self-center' onSubmit={(e) => {
                      e.preventDefault()
                      props.handleSearchdata(e.target[0].value)
                    }}>
        ...
        <div className=' self-center'>
          <button className='rounded-full text-3xl px-4 py-2 mx-1.5 bg-green-200 hover:bg-red-500'>Login</button>
          </div>
        </div>
      </div>
  )
